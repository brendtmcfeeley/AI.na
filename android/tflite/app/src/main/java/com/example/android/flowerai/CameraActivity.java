...
public class CameraActivity extends Activity
    ...
    private void changeFragment(int frag_id, List<Map.Entry<String, Float>> label, Bitmap retrievedImage) {
        TextView textView = findViewById(R.id.search_text);
        ImageButton imageButton = findViewById(R.id.imageButton2);
        ImageButton resultBackButton = findViewById(R.id.resultBack);
        ...
        if (frag_id == 1) {
            ...
            CameraResultFragment NAME = CameraResultFragment.newInstance(label, retrievedImage);
    ...
    public void onProcess(List<Map.Entry<String, Float>> label, Bitmap retrievedImage) {
        changeFragment(3, label, retrievedImage);
    }
}
